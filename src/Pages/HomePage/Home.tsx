...
export const Home = () => {
    return (
        <>
            ...
            {<CategortTiles Tiles={[
                {image: tableImage, link: '/products/furniture'},
                {image: potImage, link: '/products/kitchen-accessories'},
                {image: perfumeImage, link: '/products/fragrances'},
                {image: shirtImage, link: '/products/mens-shirts'}              
            ]} />}
